...
/**
 * Fixes for the output of the default PRNG having low entropy. The fixes need to be applied via
 * {@link #apply()} before any use of Java Cryptography Architecture primitives. A good place to
 * invoke them is in the application's {@code onCreate}.
 */
public final class PRNGFixes {
    ...
    public static class LinuxPRNGSecureRandom extends SecureRandomSpi {
         ...
         * available) into Linux PRNG. Concurrency: Read requests to the underlying Linux PRNG are
         * serialized (on sLock) to ensure that multiple threads do not get duplicated PRNG output.
         */
